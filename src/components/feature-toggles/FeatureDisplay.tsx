...
export const FeatureDisplay = ({
  ...
  return (
    <div className="grid h-fit w-full grid-cols-1 overflow-hidden rounded-xl border-2 border-zinc-900 bg-white md:h-96 md:grid-cols-12 group">
      ...
      <div className="relative col-span-1 min-h-80 border-l-0 border-t-2 border-zinc-900 bg-zinc-100 shadow-inner shadow-zinc-500 md:col-span-5 md:border-l-2 md:border-t-0 group-hover:scale-105 transition-transform duration-500">
        <AnimatePresence mode="popLayout">
          <motion.div
            initial={{
              opacity: 0,
