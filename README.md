# NightCoding Neubrutalism Template
...
NighteCoding Neubrutalism Template, is a Next.js-based web application for showcasing AI tools and resources. It is built with a focus on performance, SEO, and responsiveness, making it ideal for presenting AI-related services and products.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/JannickPepe/Neubrutalism-Temp.git
2.  ```bash
    npm install
